...
主文件约 27 KB，包含 456 条分流规则、23 条 URL 拦截、2 条原生正文重写、1 条静态响应，以及 8 份 JavaScript 的 14 条触发规则。MITM 共 38 项，原有 5 条排除项优先。
...
相较之前完整合并版，当前在开屏精简的基础上加入了 B 站和盒马：14 条 JS 触发规则、2 条原生正文重写、38 项 MITM。
